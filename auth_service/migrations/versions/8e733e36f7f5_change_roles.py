...
Revision ID: 8e733e36f7f5
Revises:
Create Date: 2025-09-18 10:44:18.019353
...
def upgrade() -> None:
    ...
    op.create_table('users',
                    ...
                    sa.Column('role', sa.Enum('administrator', 'owner', 'test_owner', 'curator', 'employee', 'intern',
                                              'handyman', name='user_role', native_enum=False), nullable=False),
