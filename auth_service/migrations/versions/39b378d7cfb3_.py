...
Revision ID: 39b378d7cfb3
Revises:
Create Date: 2025-09-20 01:35:02.076496
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('administrator', 'owner', 'test_owner', 'curator', 'employee', 'intern', 'handyman', name='user_role', native_enum=False), nullable=False),
